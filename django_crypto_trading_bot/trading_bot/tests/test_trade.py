...
class TestRisingChart(unittest.TestCase):
    def set_tickers_cache(self, exchange: str):
        ...
        tickers: dict = {
            "BNB/EUR": {"symbol": "BNB/EUR", "percentage": 2.0, "last": 1.0},
            "TRX/BNB": {"symbol": "TRX/BNB", "percentage": 6.0, "last": 1.0},
            "ETH/BNB": {"symbol": "ETH/BNB", "percentage": 10.0, "last": 1.0},
            "BTC/BNB": {"symbol": "BTC/BNB", "percentage": -2.0, "last": 1.0},
        }
